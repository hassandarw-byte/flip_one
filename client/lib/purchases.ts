...
export const PRODUCT_IDS = {
  ...
  DARK_KNIGHT: "com.flipone.skin.dark_knight",
  WEB_HERO: "com.flipone.skin.web_hero",
  GREEN_GIANT: "com.flipone.skin.green_giant",
  IRON_ARMOR: "com.flipone.skin.iron_armor",
  ICE_QUEEN: "com.flipone.skin.ice_queen",
  KAWAII_CAT: "com.flipone.skin.kawaii_cat",
  CAPTAIN_STAR: "com.flipone.skin.captain_star",
...
const getMockProducts = (): Product[] => [
  ...
  {
    productId: PRODUCT_IDS.DARK_KNIGHT,
    title: "Dark Knight",
  ...
  {
    productId: PRODUCT_IDS.WEB_HERO,
    title: "Web Hero",
  ...
  {
    productId: PRODUCT_IDS.GREEN_GIANT,
    title: "Green Giant",
  ...
  {
    productId: PRODUCT_IDS.IRON_ARMOR,
    title: "Iron Armor",
  ...
  {
    productId: PRODUCT_IDS.ICE_QUEEN,
    title: "Ice Queen",
  ...
  {
    productId: PRODUCT_IDS.CAPTAIN_STAR,
    title: "Captain Star",
