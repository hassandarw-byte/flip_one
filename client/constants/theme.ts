...
export const SkinColors: Record<string, [string, string, string]> = {
  ...
  speed_bird: ["#6EB5FF", "#1E90FF", "#4169E1"],
  cozy_bunny: ["#E8C4A0", "#8B4513", "#D2691E"],
  golden_firefly: ["#FFE066", "#DC143C", "#FFD700"],
  frost_fox: ["#C4F5FF", "#90e0ef", "#48cae4"],
  sweet_kitty: ["#FFD6E8", "#FF69B4", "#FF1493"],
  purple_imp: ["#C9AAFF", "#9370DB", "#8B008B"],
  sky_eagle: ["#A0C8FF", "#0057B8", "#FFD700"],
